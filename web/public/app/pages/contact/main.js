    ...
    var main = {
        ...
        send: function ($clickBtn) {
            ...
            if (main.validate($formSelector)) {
                ...
                swal({
                    title: main.warning_msg,
                    text: main.warning_check_inputs,
                    type: 'error',
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.indexOf("Collected information") !== -1) {
                        ...
                        swal({
                            title: main.success_msg,
                            text: main.success_form_sent,
                            type: 'success',
                            showConfirmButton: false,
                            showCloseButton: true,
                            timer: 1500
